...
*   **Beta App Feedback (beta builds):** the *same row and same form*, re-dressed by the build flag: label **"Beta App Feedback,"** orange icon, orange grain banner, orange buttons, tester-voiced intro ("You're a tester — tell us what's working and what's not.") and message placeholder ("What's working? What's not?"). **The flag changes label, color, copy, silent metadata, and — for "Something's broken" — the routing destination. It never changes what the form asks.**
...
6.  **Confirmation forks on the promise, not the words:** "Something's broken" → "Someone from our team will get back to you, usually within one business day" + "We'll reply to {email}." The other two → the thank-you ("A real person on our team reads every one of these!") which deliberately promises nothing.
7.  **Footer card** — "Need to reach us about something else?" → points at Contact for donations, prayer requests, shows, station questions.
...
**WF-F2 · The fork.** Same form, pick "Something's broken" → submit → confirmation promises a reply "usually within one business day" and names the reply-to email.
...
**WF-F4 · Beta dressing.** BETA pill **on** → row becomes "Beta App Feedback" (orange icon) → orange banner/buttons, tester copy — same fields, same validation. Remember: in beta, *every* toggle value routes to the app team.
